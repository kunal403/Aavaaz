...
const LANGUAGE_OPTIONS = locales.all
  .filter((l) => l.tag && l.tag.includes("-") && l.name) //match all locales with a tag and a name, and the tag includes a dash (e.g. en-US) then map to an object with value and label, where the value is the tag and the label is the name (and location if available)
  .map((l) => ({
    value: l.tag,
              ...
              <Field data-invalid={isInvalid}>
                <Tabs defaultValue="upload">
                  ...
                  <TabsContent value="upload">
                    <FileDropzone   //upoad file dropzone component
